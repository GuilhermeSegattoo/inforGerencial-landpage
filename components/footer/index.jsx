    ...
    return(
        ...
        text-white justify-between flex-shrink-0 ">
            <div className='flex items-center gap-3'>
                <FaFacebook className="text-2xl md:text-3xl text-zinc-400"/>
                <FaInstagram className="text-2xl md:text-3xl text-zinc-400"/>
                <FaGithub className="text-2xl md:text-3xl text-zinc-400"/>
            </div>
