...
export const Inicio = () => {
    return (
        <section id="inicio" role="contentinfo" aria-labelledby='inicio' className='flex my-10 lap:my-0 w-screen items-center justify-around lg:h-screen container mx-auto'>            
            ...
            <div className='hidden cel:hidden tab:hidden lap:inline-block xl:inline-block lap:w-auto'>
