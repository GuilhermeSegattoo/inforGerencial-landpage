                    ...
                    <section id="contato" className='flex lg:h-screen justify-center items-center'>
                        <div className='grid grid-cols-1 lg:grid-cols-2 max-w-5xl'>
                            <div className='flex flex-col items-center gap-4'>
                                <h2 className='text-white text-3xl font-bold'>Envie sua solicitação<span className='text-[#D30490]'>.</span></h2>
                                ...
                                <form className='flex flex-col justify-center items-center'>
                                    <div className='flex gap-3 flex-col sm:flex-row p-2'>
                                        <div className='flex flex-col'>
                                            <label htmlFor='form_name' className='text-white'>Nome<Required /></label>
                                            <input required type="text" id='form_name' className='bg-white rounded w-80 sm:w-60 p-1' />
                                        </div>
                                        <div className='flex flex-col'>
                                            <label htmlFor='form_last_name' className='text-white'>Sobrenome<Required /></label>
                                            <input required type="text" id='form_last_name' className='bg-white rounded w-80 sm:w-80 p-1' />
                                        </div>
                                    </div>
                                    <div className='flex gap-3 flex-col sm:flex-row p-2'>
                                        <div className='flex flex-col'>
                                            <label htmlFor='form_email' className='text-white'>E-mail corporativo<Required /></label>
                                            <input required type="text" id='form_email' className='bg-white rounded w-80 sm:w-72 p-1' />
                                        </div>
                                        <div className='flex justify-start gap-3'>
                                            <div className='flex flex-col'>
                                                <label htmlFor='form_cellphone' className='text-white'>Celular<Required /></label>
                                                <select required id='form_cellphone_code' className='bg-white rounded w-24 sm:w-24 p-1'>
                                        ...
                                        <div className='flex justify-start items-end gap-3'>
                                            <div className='flex flex-col'>
                                                <input required type="text" id='form_cellphone' className='bg-white rounded w-80 sm:w-40 p-1' />
                                            </div>
                                        </div>
                                    </div>
                                    <div className='flex gap-3 flex-col sm:flex-row p-2'>
                                        ...
                                        <div className='flex flex-col'>
                                            ...
                                            <input type="text" id='form_website' className='bg-white rounded w-80 sm:w-96 p-1' />
                                        </div>
                                    </div>
                                    <div className='flex gap-3 flex-col sm:flex-row p-2'>
                                        <div className='flex justify-start flex-col'>
                                            <label htmlFor='form_office' className='text-white'>Coloque uma breve descrição sobre o que deseja</label>
                                            <textarea cols={56} rows={3} id='form_office' className='bg-white rounded w-80 sm:w-full p-1'></textarea>
                                        </div>
                                    </div>
